...
ROUND2_MODES = set(POSITION_CONFIG["round2"]["modes"])
ROUND2_POLICIES = set(POSITION_CONFIG["round2"]["policies"])
SYSTEM_ROOTS = (
    "法理学",
    "宪法学",
    "行政法学",
...
def build_round1_prompt(
    ...
    instructions = POSITION_CONFIG["prompt_templates"]["round1_instructions"].strip()
...
{POSITION_CONFIG["prompt_templates"]["round2_instructions"].strip()}
...
def build_light_round2_prompt(
    ...
    light_instructions = POSITION_CONFIG["prompt_templates"][
        "light_round2_instructions"
    ].strip()
    return f"""你是一位法学知识体系分析专家。
