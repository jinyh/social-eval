...
SAMPLES = {
    "negative": [
        ("1.邵莉莉 - 2025 - 论绿色溯源法律制度的规范构造.pdf", "normative_statement_without_specifics"),
        ("2.杨清望 - 2025 - 爱国主义法治建设的理论逻辑与实施体系.pdf", "fixed_framework_mechanical_application"),
        ("10.崔聪聪 - 2024 - 个人信息监管沙箱的法理基础与制度构建.pdf", "concept_stacking_without_explanation"),
    ],
    "positive": [
...
async def main():
    ...
    # 初始化 provider
    provider = create_providers(["qwen3.6-plus"])[0]
